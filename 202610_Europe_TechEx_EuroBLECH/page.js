...
const CHECKLIST = [
  ...
  '<span class="line-icon line-icon-ticket" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h16v3a2 2 0 0 0 0 4v3H4v-3a2 2 0 0 0 0-4z"/><path d="M14 7v2m0 3v2m0 3v0"/></svg></span> 10/24 FRA Priority Lounge の同伴可否を確認（美馬・金築はステータスもPPも無い）',
];
