...
const CHECKLIST = [
  ...
  '<span class="line-icon line-icon-train" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="3" width="14" height="13" rx="3"/><path d="M5 10h14"/><circle cx="9" cy="13" r="1"/><circle cx="15" cy="13" r="1"/><path d="M8 16l-2 4m10-4 2 4"/></svg></span> 美馬・金築 FRA→Göttingen 鉄道予約（ICE11＋ECE8）',
  ...
  '<span class="line-icon line-icon-ticket" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h16v3a2 2 0 0 0 0 4v3H4v-3a2 2 0 0 0 0-4z"/><path d="M14 7v2m0 3v2m0 3v0"/></svg></span> 10/24 FRA Priority Lounge はT3に2つ（Qatar専用／AA・BA・CX・JAL用）。当日どちらかと、同伴1名を誰にするかを決める',
];
